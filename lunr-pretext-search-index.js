...
},
{
  ...
  "number": "",
  "title": "Dedication",
  "body": " For my wife Hazel and my dogs Dana and Milla.  "
},
{
  "id": "frontmatter-5",
  "level": "1",
...
{
  "id": "exer_quadLargerLinear",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#exer_quadLargerLinear",
  "type": "Exercise",
  "number": "1.1.3.4",
  "title": "Quadratic is Larger than Linear.",
  "body": " Quadratic is Larger than Linear  even numbers   Create a proof of the theorem: For all , .     The base case is .     Since , the base case is true.    Since , the base case is true.     We proceed by induction.    For the inductive step, suppose . We show .    This completes the inductive step and the proof by induction.    Adding to both sides of gives us     Since , we have .    "
},
{
  "id": "sec_inductionWellOrdering-6-6",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-6",
  "type": "Exercise",
  "number": "1.1.3.5",
  "title": "",
  "body": "  Here you will try out an inductive proof on your own. You'll be guided through a proof of the statement: For every  That is, the sum of the first squares can be computed as .     Identify what is and verify is true.    The statement is the equation in the statement for a given .     is the statement .  Thus is the statement which is certainly true.    All the glorious details about how to do the first step.      Verify that if is true, then must also be true.    Write out both statements and . Try to manipulate to get .    We first assume that is true. This means We need to show somehow that   Starting with , we (fill in the details)    "
},
{
  "id": "sec_inductionWellOrdering-6-7",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-7",
  "type": "Exercise",
  "number": "1.1.3.6",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-8",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-8",
  "type": "Exercise",
  "number": "1.1.3.7",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-9",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-9",
  "type": "Exercise",
  "number": "1.1.3.8",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-10",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-10",
  "type": "Exercise",
  "number": "1.1.3.9",
  "title": "",
  "body": "  Prove for all , we have .   "
...
{
  "id": "sec_inductionWellOrdering-6-11",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-11",
  "type": "Exercise",
  "number": "1.1.3.10",
  "title": "",
  "body": "  Prove for all , we have .   "
...
{
  "id": "sec_inductionWellOrdering-6-12",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-12",
  "type": "Exercise",
  "number": "1.1.3.11",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-13",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-13",
  "type": "Exercise",
  "number": "1.1.3.12",
...
{
  "id": "sec_inductionWellOrdering-6-15",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-15",
  "type": "Exercise",
  "number": "1.1.3.14",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-16",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-16",
  "type": "Exercise",
  "number": "1.1.3.15",
  "title": "",
...
{
  "id": "sec_inductionWellOrdering-6-17",
  "level": "2",
  "url": "sec_inductionWellOrdering.html#sec_inductionWellOrdering-6-17",
  "type": "Exercise",
  "number": "1.1.3.16",
  "title": "",
...
},
{
  ...
  "number": "1.2.1",
  "title": "",
  "body": " divides (integers)  factor (integers)    Divides    Let . We say that  divides  , and write , if there is an integer such that . In this case, say that and are factors of . If no such exists, we write .   "
},
{
...
},
{
  ...
  "body": " The Division Algorithm for  Division Algorithm ( )   Let with . Then there exist unique integers such that , where .    If , this is the Division Algorithm. Suppose???   "
},
{
  "id": "def_gcdZ",
  "level": "2",
  ...
  "number": "1.2.7",
  "title": "",
  "body": " greatest common divisor ( )    Greatest Common Divisor of    Let such that and are not both 0. A greatest common divisor of and , denoted , is a natural number satisfying    and     if and and , then .     If , we say that and are relatively prime or coprime .   "
},
{
...
{
  "id": "sec-divisibility-gcd-4-8",
  "level": "2",
  "url": "sec-divisibility-gcd.html#sec-divisibility-gcd-4-8",
  "type": "Theorem",
  "number": "1.2.8",
  "title": "",
...
{
  "id": "sec-divisibility-gcd-4-11",
  "level": "2",
  "url": "sec-divisibility-gcd.html#sec-divisibility-gcd-4-11",
  "type": "Activity",
  "number": "1.2.7",
  "title": "",
...
},
{
  ...
  "type": "Theorem",
  "number": "1.3.7",
  "title": "Fundamental Theorem of Arithmetic–Existence Part.",
  "body": " Fundamental Theorem of Arithmetic Existence Part   Every natural number is either a prime number or it can be expressed as a finite product of prime numbers. That is, for every natural number , there exist primes and natural numbers such that .    "
},
{
...
{
  "id": "exer-divisibility-gcd-bezout-coeff",
  "level": "2",
  "url": "sec-primesFactorization.html#exer-divisibility-gcd-bezout-coeff",
  "type": "Exercise",
  "number": "1.3.3.5",
  "title": "",
  "body": "  For each of the pairs of integers in find Bézout coefficients. That is, find such that .   "
...
},
{
  "id": "defn_relation",
  "level": "2",
  "url": "sec_integersModuloM.html#defn_relation",
  "type": "Definition",
  "number": "1.4.1",
  "title": "",
...
{
  "id": "ssec_equivalenceRelations-6",
  "level": "2",
  "url": "sec_integersModuloM.html#ssec_equivalenceRelations-6",
  "type": "Activity",
  "number": "1.4.1",
  "title": "",
...
},
{
  ...
  "number": "1.4.5",
  "title": "",
  "body": " integers modulo     Integers modulo    The set of equivalence classes of under the equivalence relation congruence modulo is called the integers modulo , and is denoted (pronounced \"Z mod m\").   "
},
{
...
},
{
  ...
  "number": "1.4.9",
  "title": "",
  "body": "  Let and . Then the following are well-defined operations on the equivalence classes:    Addition modulo : .     Multiplication modulo : .      "
},
{
  "id": "ssec_integersModm-13",
  "level": "2",
  "url": "sec_integersModuloM.html#ssec_integersModm-13",
  "type": "Activity",
  "number": "1.4.6",
  "title": "",
  "body": "  Without passing back to , find the smallest nonnegative integer representative of the resulting equivalence classes.  in  in  in  in  in     "
},
{
  "id": "table-z3addition",
  "level": "2",
...
},
{
  ...
  "number": "1.4.6.2",
  "title": "",
  "body": "  List the elements in and . Use the convention that equivalence class representatives start with and increase.   "
},
{
...
},
{
  ...
  "number": "2.1.1",
  "title": "",
  "body": "  Prove that the relation defined in is an equivalence relation. Recall . We should regard the relation as being defined one the set where we regard the fraction as the ordered pair .   "
},
{
...
{
  "id": "subsec-numberSystems-6",
  "level": "2",
  "url": "sec_fields.html#subsec-numberSystems-6",
...
{
  "id": "subsec-numberSystems-7",
  "level": "2",
  "url": "sec_fields.html#subsec-numberSystems-7",
  "type": "Activity",
  "number": "2.1.2",
  "title": "",
  "body": "  Write down two binary operations on that are not well-defined.   "
},
{
...
{
  "id": "ex_rationalsAreField",
  "level": "2",
  "url": "sec_fields.html#ex_rationalsAreField",
  "type": "Example",
  "number": "2.1.6",
...
{
  "id": "ex_complexAreField",
  "level": "2",
  "url": "sec_fields.html#ex_complexAreField",
  "type": "Example",
  "number": "2.1.7",
...
},
{
  ...
  "number": "2.1.9",
  "title": "",
  "body": " finite field of order    Finite Field of Order    For a prime, we denote by the finite field and call it the finite field of order  .   "
},
{
  ...
  "body": " Properties of Fields   Let be a field.   The additive identity is unique.    For all , .    Additive inverses are unique.    The multiplicative identity is unique.    Multiplicative inverses are unique.           "
},
{
...
{
  "id": "subsec-subfieldsAndExtensions-5",
  "level": "2",
  "url": "sec_fields.html#subsec-subfieldsAndExtensions-5",
  "type": "Theorem",
  "number": "2.1.12",
  "title": "",
...
},
{
  "id": "exer_fieldsTF",
  "level": "2",
  "url": "sec_fields.html#exer_fieldsTF",
  "type": "Exercise",
  "number": "2.1.7.1",
  "title": "",
...
},
{
  "id": "exers_fields-3",
  "level": "2",
  "url": "sec_fields.html#exers_fields-3",
  "type": "Exercise",
  "number": "2.1.7.2",
  "title": "",
  "body": "  Consider the set where and addition and multiplication are defined in the usual way:     Prove is a field only using . If it helps, follow .    Prove is a field using the . If it helps, follow .     "
},
{
  "id": "exers_fields-4",
  "level": "2",
  "url": "sec_fields.html#exers_fields-4",
  "type": "Exercise",
  "number": "2.1.7.3",
  "title": "",
  "body": "  In contrast to the previous exercise, consider the set of Gaussian Integers  Which field axioms fail for with the same rule for addition and multiplication as in the previous exercise?   "
},
{
  "id": "exers_fields-5",
  "level": "2",
  "url": "sec_fields.html#exers_fields-5",
  "type": "Exercise",
  "number": "2.1.7.4",
  "title": "",
  "body": "  Show that the set of reciprocals of in : is not a subfield of . Which parts of the subfield test fail?   "
},
{
  "id": "exers_fields-6",
  "level": "2",
  "url": "sec_fields.html#exers_fields-6",
  "type": "Exercise",
  "number": "2.1.7.5",
  "title": "",
  "body": "  Let and . Letting be the usual addition and multiplication of real numbers. Prove that neither nor are subfields of . Either say which of the field axioms fail or what parts of the subfield test fail.   "
},
{
  ...
  "number": "2.1.7.6",
  "title": "",
  "body": "  Consider the set Prove that is a field with the usual addition and multiplication of matrices.   Prove that is a field with the usual addition and multiplication of matrices. You may use that multiplication and addition of -matrices are closed operations and that multiplication distributes (both ways) over addition.  Is there an element such that (the identity matrix)? That is, can you solve the equation in ?    "
},
{
  "id": "exers_fields-8",
  "level": "2",
  "url": "sec_fields.html#exers_fields-8",
  "type": "Exercise",
  "number": "2.1.7.7",
  "title": "",
  "body": "  Prove that in a field, the additive identity is unique. Do so as follows.    Suppose are two additive identities of . Write down the definition of additive identity from for each of and .    Substitute into the defining equation for the additive identity and conversely.    Deduce . This is not the only way of doing this but this method generalizes appropriately for both the next exercises and the more abstract algebraic structures we will encounter further on.     "
},
{
  "id": "exers_fields-9",
  "level": "2",
  "url": "sec_fields.html#exers_fields-9",
  "type": "Exercise",
  "number": "2.1.7.8",
  "title": "",
...
},
{
  "id": "exers_fields-10",
  "level": "2",
  "url": "sec_fields.html#exers_fields-10",
  "type": "Exercise",
  "number": "2.1.7.9",
  "title": "",
...
},
{
  "id": "exers_fields-12",
  "level": "2",
  "url": "sec_fields.html#exers_fields-12",
  "type": "Exercise",
  "number": "2.1.7.11",
...
},
{
  "id": "exers_fields-13",
  "level": "2",
  "url": "sec_fields.html#exers_fields-13",
  "type": "Exercise",
  "number": "2.1.7.12",
  "title": "",
...
},
{
  "id": "exers_fields-14",
  "level": "2",
  "url": "sec_fields.html#exers_fields-14",
  "type": "Exercise",
  "number": "2.1.7.13",
  "title": "",
  "body": " Quadratic Extensions of   Suppose that is such that . Define the rationals adjoin by where addition and multiplication are defined by     Prove is a field. You may appeal to as in .    Show that has as a subfield or equivalently that is an extension of . This type of extension is called a quadratic extension .     "
},
{
  "id": "sec_rings",
  "level": "1",
...
},
{
  "id": "defn_commRing",
  "level": "2",
  "url": "sec_rings.html#defn_commRing",
  "type": "Definition",
  "number": "2.2.8",
  "title": "",
...
},
{
  ...
  "number": "2.2.4.5",
  "title": "",
  "body": "  Consider the set of matrices with real entries, , as in .    Prove is a ring with the usual matrix addition and matrix multiplication.    What is special about ? Does your proof work if is replaced by an arbitrary ring ?    What is special about ? What about the set of matrices with entries in a ring , denoted ?     "
},
{
  "id": "exers_rings-6",
  "level": "2",
...
},
{
  ...
  "body": " Upper Triangular Matrices   Upper Triangular Matrices   Use the subring test to prove that the collection of upper triangular matrices -matrices over a general ring , denoted forms a ring. An upper triangular -matrix looks like where .   "
},
{
  "id": "exers_rings-11",
  "level": "2",
...
},
{
  ...
  "number": "3.1.2",
  "title": "",
  "body": "  For each homomorphism in , find (with justification), the kernel.   "
},
{
...
},
{
  ...
  "body": "  Evaluation Homomorphism  Evaluation Homomorphism   Let be a ring. Consider the polynomial ring over . For any , define the evaluation function: by . Prove that is always an epimorphism. That is, it is a homomorphism which is always surjective.  Why does this exercise not contradict the previous exercise?   "
},
{
...
},
{
  ...
  "number": "3.1.7.18",
  "title": "",
  "body": "  Match each type of (blank)-morphism with its definition     epimorphism  An onto homomorphism    monomorphism  An into homomorphism    isomorphism  An onto and into homomorphism    automorphism  An isomorphism where codomain is domain    "
},
{
  "id": "sec_ideals",
  "level": "1",
...
},
{
  ...
  "number": "3.2.9",
  "title": "",
  "body": " Principal Ideal      Principal Ideal Generated by  Let be a commutative ring and let . The set is an ideal (called the principal ideal generated by ).    Observe that .  Moreover, if , . Finally, if and , .  Thus, is an ideal.   "
},
{
...
},
{
  ...
  "number": "3.2.5.9",
  "title": "",
  "body": "  Sums of Ideals  ideals (sums)   Suppose are ideals of the ring . Define Show that is an ideal.   "
},
{
  "id": "exers_ideals-10",
  "level": "2",
...
},
{
  ...
  "number": "3.2.5.11",
  "title": "",
  "body": " Products of Ideals  ideals (products)    Suppose are ideals of the ring . Define to be the set of finite sums of products of elements of and . Show that is an ideal.   "
},
{
  "id": "exers_ideals-12",
  "level": "2",
...
},
{
  ...
  "number": "3.2.5.16",
  "title": "",
  "body": "  Radical Ideals   Another important ideal that arises in commutative algebra are radical ideals . Let be an ideal in a commutative ring. Define the radica of to be the set Prove that is an ideal.   "
},
{
  "id": "exers_ideals-17",
  "level": "2",
...
},
{
  ...
  "body": " Noether's Isomorphism Theorem  E. Noether  First Isomorphism Theorem  Noether Isomorphism Theorem   Let be a homomorphism of commutative rings. Then .  In particular, if is an epimorphism (it is onto), .   "
},
{
  "id": "subsec--3",
  "level": "2",
...
{
  "id": "exer_quotientRingsTF",
  "level": "2",
  "url": "sec_quotientRings.html#exer_quotientRingsTF",
  "type": "Exercise",
  "number": "3.3.5.1",
  "title": "",
...
{
  "id": "exers_quotientRings-2",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-2",
  "type": "Exercise",
  "number": "3.3.5.2",
  "title": "",
...
{
  "id": "exers_quotientRings-3",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-3",
  "type": "Exercise",
  "number": "3.3.5.3",
  "title": "",
...
{
  "id": "exers_quotientRings-4",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-4",
  "type": "Exercise",
  "number": "3.3.5.4",
  "title": "",
  "body": "  Let and . Carry out the coset arithmetic in the quotient :                    "
...
{
  "id": "exers_quotientRings-5",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-5",
  "type": "Exercise",
  "number": "3.3.5.5",
  "title": "",
...
{
  "id": "exers_quotientRings-6",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-6",
  "type": "Exercise",
  "number": "3.3.5.6",
  "title": "",
...
{
  "id": "exers_quotientRings-7",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-7",
  "type": "Exercise",
  "number": "3.3.5.7",
  "title": "",
...
{
  "id": "exers_quotientRings-8",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-8",
  "type": "Exercise",
  "number": "3.3.5.8",
  "title": "",
...
{
  "id": "exers_quotientRings-9",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-9",
  "type": "Exercise",
  "number": "3.3.5.9",
  "title": "",
...
{
  "id": "exers_quotientRings-10",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-10",
  "type": "Exercise",
  "number": "3.3.5.10",
  "title": "",
...
{
  "id": "exers_quotientRings-11",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-11",
  "type": "Exercise",
  "number": "3.3.5.11",
  "title": "",
...
{
  "id": "exers_quotientRings-12",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-12",
  "type": "Exercise",
  "number": "3.3.5.12",
  "title": "",
...
{
  "id": "exers_quotientRings-13",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-13",
  "type": "Exercise",
  "number": "3.3.5.13",
  "title": "",
...
{
  "id": "exers_quotientRings-14",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-14",
  "type": "Exercise",
  "number": "3.3.5.14",
  "title": "",
...
{
  "id": "exers_quotientRings-15",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-15",
  "type": "Exercise",
  "number": "3.3.5.15",
  "title": "",
...
{
  "id": "exers_quotientRings-17",
  "level": "2",
  "url": "sec_quotientRings.html#exers_quotientRings-17",
  "type": "Exercise",
  "number": "3.3.5.17",
  "title": "",
...
},
{
  ...
  "number": "3.4.14",
  "title": "",
  "body": " ideal maximal      maximal ideal  Let be a commutative ring and let be a proper ideal. We say that is a maximal ideal if no proper ideal of properly contains . That is, if is an ideal satisfying , either or .   "
},
{
...
},
{
  ...
  "number": "3.4.16",
  "title": "",
  "body": "  Let be a commutative ring and an ideal of . Then is maximal if and only if is a field.    If is a field, assume is an ideal of that properly contains . Let ; then is a nonzero element of , and since is a field, there is some such that . Since , . As , we have , and thus , which means . Thus, is maximal.  Now, suppose that is maximal and let . Apply the previous lemma to obtain , where . Then    "
},
{
...
},
{
  ...
  "number": "4.1",
  "title": "",
  "body": "  In this section, we'll seek to answer the questions:    What is an irreducible polynomial? Are there any tools we can use to determine if a given polynomial is irreducible?   "
},
{
  "id": "ssec_polynomialFunctions-5",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-5",
  "type": "Definition",
  "number": "4.1.1",
  "title": "",
  "body": "  Let be a commutative ring. For any , the corresponding polynomial function  is defined, for all by . We usually denote by , and say that is the polynomial evaluated at .   "
},
{
  "id": "ssec_polynomialFunctions-7",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-7",
  "type": "Example",
  "number": "4.1.2",
  "title": "Polynomials vs Polynomial Functions.",
  "body": " Polynomials vs Polynomial Functions  Consider the polynomial ring over . We have, in particular, the polynomials for each . So the number of polynomials over is (countably) infinite.  By contrast, the number of functions is far less! There are four functions: the two constant functions, the identity, and the transposition. In particular, the assignment to is not injective. However, it is surjective (exercise).  By contrast, if we consider polynomials over . The assignment to a polynomial function is injective but not surjective. There are more functions than polynomial functions. There are even more smooth functions than polynomial functions.  "
},
{
  "id": "ssec_polynomialFunctions-8",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-8",
  "type": "Definition",
  "number": "4.1.3",
  "title": "",
...
{
  "id": "thm_rootsLinearFactors",
  "level": "2",
  "url": "sec_factoringPolynomials.html#thm_rootsLinearFactors",
  "type": "Theorem",
  "number": "4.1.4",
  "title": "Roots and Linear Factors.",
  "body": " Roots and Linear Factors   Let be a commutative ring. For any polynomial and , there exists a unique polynomial with In particular, is a root of if and only if is a factor of .   "
},
{
  "id": "ssec_polynomialFunctions-11",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-11",
  "type": "Proof",
  "number": "4.1.1.1",
  "title": "",
  "body": " By the division algorithm, there exists unique with where . Thus is constant. Since evaluation is a homomorphism we can evaluate at : This completes the first part.  If is a zero of , then . If is a factor of , then and so So is a root.  "
},
{
...
{
  "id": "ssec_polynomialFunctions-13",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-13",
  "type": "Activity",
  "number": "4.1.1",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-15",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-15",
  "type": "Activity",
  "number": "4.1.2",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-17",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-17",
  "type": "Theorem",
  "number": "4.1.6",
...
{
  "id": "ssec_polynomialFunctions-19",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-19",
  "type": "Exploration",
  "number": "4.1.3",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-20",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-20",
  "type": "Definition",
  "number": "4.1.7",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-21",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-21",
  "type": "Exploration",
  "number": "4.1.4",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-22",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-22",
  "type": "Theorem",
  "number": "4.1.8",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-23",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-23",
  "type": "Theorem",
  "number": "4.1.9",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-25",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-25",
  "type": "Activity",
  "number": "4.1.5",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-27",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-27",
  "type": "Theorem",
  "number": "4.1.10",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-31",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-31",
  "type": "Theorem",
  "number": "4.1.11",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-32",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-32",
  "type": "Proof",
  "number": "4.1.1.2",
  "title": "",
...
{
  "id": "ssec_polynomialFunctions-33",
  "level": "2",
  "url": "sec_factoringPolynomials.html#ssec_polynomialFunctions-33",
  "type": "Paragraph (with a defined term)",
  "number": "",
  "title": "",
